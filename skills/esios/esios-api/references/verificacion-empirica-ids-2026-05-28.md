...
El dashboard usa `convertEsiosValue()` de `src/shared/esios-units.js` que coincide exactamente con estas reglas. Para el solar, el dashboard usa **10206** (no 10205).