...
description: "Arquitectura completa de un dashboard web que consume APIs externas — patrón desde el dato crudo hasta el renderizado. Válido para proyectos con 1+ APIs, mapas, forecast."
version: 1.0.0
author: Ntizar
---
