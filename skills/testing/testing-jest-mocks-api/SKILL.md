...
metadata:
  hermes:
    tags: [testing, jest, mocks, api, fixtures, nodejs]
    related_skills: [frontend-fechas-timezone-local, conversion-unidades-api-externa, fetch-paralelo-fallos-parciales]
---
